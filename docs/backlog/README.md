...
|---|---|---|---|
| [S-001](S-001-layout-et-accueil.md) | Layout, shadcn-svelte, page d'accueil | todo | — |
| [S-002](S-002-auth-email-password.md) | Inscription / connexion email+password | todo | S-001 |
